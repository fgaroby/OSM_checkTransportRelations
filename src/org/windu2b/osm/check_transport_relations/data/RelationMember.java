 ...
 * Since membership may be qualified by a "role", a simple list is not
 * sufficient.
 * 
 */
public class RelationMember
{
	 ...
	 * 
	 * @param role
	 *            Can be null, in this case it's save as ""
	 * @param member
	 *            Cannot be null
	        ...
	        throws IllegalArgumentException
	{
		...
		if ( member == null )
		    throw new IllegalArgumentException(
		            "Relation member cannot be null" );
		this.role = role;
		this.member = member;
	}
	...
	/**
	 * Copy constructor. This constructor is left only for backwards
	 * compatibility. Copying RelationMember doesn't make sense because it's
	 * immutable
	 * 
	 * @param other
	 *            relation member to be copied.
	 */
