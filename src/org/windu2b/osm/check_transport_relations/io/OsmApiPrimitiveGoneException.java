...
/**
 * Represents an exception thrown by the OSM API if JOSM tries to update or
 * delete a primitive which is already deleted on the server.
 * 
 */
public class OsmApiPrimitiveGoneException extends OsmApiException
{
	...
	/**
	 * Replies the type of the primitive this exception was thrown for. null, if
	...
	/**
	 * Replies the id of the primitive this exception was thrown for. 0, if the
	 * id is not known.
	 * 
