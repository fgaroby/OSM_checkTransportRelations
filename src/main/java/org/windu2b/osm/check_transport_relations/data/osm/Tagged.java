...
public interface Tagged
{
	 ...
	 * 
	 * @param keys
	 *            the map of key value pairs. If null, reset to the empty map.
	 */
	 ...
	 *            the key
	 * @param value
	 *            the value. If null, removes the key/value pair.
	 */
	...
	/**
	 * Replies the value of the given key; null, if there is no value for this
	 * key
	 * 
	 * @param key
	 *            the key
