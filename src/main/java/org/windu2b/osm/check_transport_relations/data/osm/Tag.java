...
/**
 * Tag represents an immutable key/value-pair. Both the key and the value may be
 * empty, but not null.
 * 
 */
public class Tag
{
	...
	/**
	 * Create a tag whose key is <code>key</code> and whose value is empty.
	 * 
	 * @param key
	...
	/**
	 * Creates a tag for a key and a value. If key and/or value are null, the
	...
	/**
	 * Replies true if the key of this tag is equal to <code>key</code>. If
	 * <code>key</code> is null, assumes the empty key.
	 * 
	 * @param key
	 *            the key
