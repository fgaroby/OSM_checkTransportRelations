...
public class OsmTransferException extends Exception
{
	...
	/**
	 * Constructs an {@code OsmTransferException} with {@code null} as its error
	...
	/**
	 * Constructs an {@code OsmTransferException} with the specified detail
	...
	/**
	 * Constructs an {@code OsmTransferException} with the specified cause and a
	 ...
	 * 
	 * @param url
	 *            the URL related to this error (which is saved for later
	 *            retrieval by the {@link #getUrl} method).
	 */
